...
function appendUserInstructionGuidance(lines, context) {
  ...
  lines.push(
    "ユーザーからの補足メモがあるときは、その観点を優先しつつ、写真の中で確かめられる根拠と結びつけて具体的に書いてください。"
  );
  lines.push(
    "補足メモをそのまま言い換えるだけで終わらせず、写真に写っている様子や変化として掘り下げてください。"
  );
  lines.push(
    "補足メモに含まれる着眼点や疑問へ、観察に基づいて答えるつもりでコメントを整えてください。"
  );
}
