...
function extractContextCueTags(context) {
  var source = [
    ...
    context && context.currentPhotoMemo ? String(context.currentPhotoMemo) : "",
    context && context.previousPhotoMemo ? String(context.previousPhotoMemo) : "",
  ].join(" ");
  var tags = [];
...
function buildCueSegments(context, seed) {
  ...
  var currentPhotoMemo =
    context && context.currentPhotoMemo ? normalizeComment(String(context.currentPhotoMemo).slice(0, 80)) : "";
  var plants = normalizePlantNames(context && context.plantNames);
...
function buildComparisonSegments(context, seed) {
  ...
  var previousPhotoMemo =
    context && context.previousPhotoMemo ? normalizeComment(String(context.previousPhotoMemo).slice(0, 80)) : "";
  var segments = [];
